CREATE TABLE `dt_order0` (
                             ...
                             `pay_price_i` int(11) DEFAULT NULL COMMENT '实付金额整数位',
                             `pay_price_d` int(11) DEFAULT NULL COMMENT '实付金额小数位',
                             `pay_complete_time` timestamp NULL DEFAULT NULL COMMENT '支付完成时间',
                             `order_complete_time` timestamp NULL DEFAULT NULL COMMENT '订单完成时间',
